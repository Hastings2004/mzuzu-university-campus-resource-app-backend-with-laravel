...
<head>
    ...
    <title>Booking Approved - Campus Resource Booking System</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            ...
            <div class="title">Booking Approved</div>
        </div>
        <div class="content">
            <p>Hello <strong>{{ $notifiable->first_name }} {{ $notifiable->last_name }}</strong>,</p>
            <p>Your booking has been <strong>approved</strong>! You may now use the resource at the scheduled time.</p>
            ...
            <p>If you did not make this booking, please contact support or ignore this email.</p>
        </div>
        <div class="footer">
