...
class BookingController extends Controller
{
    ...
    public function store(StoreBookingRequest $request): JsonResponse
    {
        ...
        $response = [
            ...
            'booking' => $result['booking'] ? array_merge($result['booking']->toArray(), ['uuid' => $result['booking']->uuid]) : null,
        ];
    ...
    public function show(Booking $booking): JsonResponse
    {
        ...
        $bookingArray = array_merge($booking->toArray(), ['uuid' => $booking->uuid]);
        return response()->json([
            'success' => true,
            'booking' => $bookingArray // Include uuid
        ]);
    }
    ...
    public function bookingHistory(Request $request){
        ...
        //$bookings = Booking::with("user")->where("status", ['completed']);
